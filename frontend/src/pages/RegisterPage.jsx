              ...
              <div className="bg-emerald-50/80 border border-emerald-200 p-4 rounded-2xl space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-emerald-950">
                      Join Official DSDL WhatsApp Group
                    </span>
                  </div>
                  <a
                ...
                <label className="flex items-start space-x-3 cursor-pointer pt-1">
                  <input
                    ...
                    onChange={(e) => handleInputChange('whatsappConfirmedByUser', e.target.checked)}
                    className="mt-0.5 h-4 h-4 text-emerald-600 rounded border-slate-300 focus:ring-emerald-500"
                  />
                  <span className="text-xs font-semibold text-slate-700">
                    I confirm that I have joined (or intend to join) the DSDL WhatsApp group to receive recruitment updates.
                  </span>
                </label>
              </div>
